...
- JavaScript (ES6+): Implementação de animações de entrada e comportamento de scroll suave.
...
- Tecnologia: WordPress e Elementor.

- Destaque: Criação de interface visual para nicho artístico, com foco em chamada para ação (CTA) clara ("Junte-se a nós") e design de impacto.
